...
{
    public class empleadoDeSalarioBaseMASComsion : Object
    {
        ...
        public empleadoDeSalarioBaseMASComsion(string nombre, string apellido, string nss, decimal tarifa, decimal venta)
        {
